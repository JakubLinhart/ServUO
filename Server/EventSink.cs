...
namespace Server
{
    ...
    public static class EventSink
    {
        ...
        internal static void InvokeMobileLocationChanged(Mobile mobile)
        {
            var handler = MobileLocationChanged;
            if (handler != null)
            {
                handler.Invoke(null, new Server.MobileLocationChanged(mobile) );
            }
        }

        public static event EventHandler<MobileLocationChanged> MobileLocationChanged;
    }
    ...
    public class MobileLocationChanged
    {
        public Mobile Mobile { get; }

        public MobileLocationChanged(Mobile mobile)
        {
            this.Mobile = mobile;
        }
    }
